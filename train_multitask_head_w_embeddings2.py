...
class AuxVisionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        pid = data['pid']
        embedding_path_ts0 = data["embedding_path_ts0"].replace("mfm_embeddings", "mfm_embeddings1")
        embedding_path_ts1 = data["embedding_path_ts1"].replace("mfm_embeddings", "mfm_embeddings1")
        embedding_path_ts2 = data["embedding_path_ts2"].replace("mfm_embeddings", "mfm_embeddings1")
...
class TrainingArguments:
    ...
    output_dir: str = field(default="./multitask_embeddings_ts3_v2_aux_output", metadata={"help": "Output directory."})
